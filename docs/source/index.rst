...
`nemo-spinup-forecast <https://github.com/m2lines/nemo-spinup-forecast>`_, which
...
`Etienne Meunier <https://github.com/Etienne-Meunier>`_, whose work on
`Metrics-Ocean <https://github.com/Etienne-Meunier/Metrics-Ocean>`_ laid the
